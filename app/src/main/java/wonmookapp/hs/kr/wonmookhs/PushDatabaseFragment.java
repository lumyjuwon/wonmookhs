...
public class PushDatabaseFragment extends Fragment implements
    ...
    private static final String TAG = "PushDatabaseFragment";
    //Recycler View Setup
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.pushdatabase_recyclerview, container, false);
        ...
        */
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<PushCardViewRoom, RoomViewHolder>(
                ...
                R.layout.pushdatabase_cardview,
                RoomViewHolder.class,
                mFirebaseDatabaseReference.child(PUSH)) {
            @Override
